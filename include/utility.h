...
extern const float historyKeyframeSearchRadius = 15.0; // key frame that is within n meters from current pose will be considerd for loop closure
extern const int   historyKeyframeSearchNum = 50; // 2n+1 number of hostory key frames will be fused into a submap for loop closure
